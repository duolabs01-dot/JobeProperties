...
export function FloatingWhatsAppButton() {
  ...
  return (
    <MagneticButton className="fixed bottom-4 right-4 z-[70] hidden lg:block">
      <ButtonLink
        href={whatsappUrl}
        target="_blank"
        rel="noreferrer"
        aria-label="Chat on WhatsApp"
        className="home-whatsapp-pulse inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_18px_45px_rgba(37,211,102,0.35)] transition duration-300 hover:scale-[1.03]"
      >

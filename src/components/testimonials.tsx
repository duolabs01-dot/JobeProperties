...
// TODO: replace with real resident quotes and exact approved attributions.
            ...
            <RevealItem key={testimonial.attribution}>
              ...
              >
                <div className="space-y-5">
                  <p className="absolute left-4 top-4 font-display text-[5rem] leading-none text-[color:var(--accent-light)]">
                    “
                  </p>
                  <p className="relative pt-10 font-display text-[1.1rem] leading-8 italic text-[color:var(--ink)]">
                    {testimonial.quote}
                  </p>
                </div>

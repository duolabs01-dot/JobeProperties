    ...
    <RevealSection className="bg-white" stagger>
      <div className="mx-auto w-full max-w-7xl px-5 py-20 sm:px-8 lg:px-12 lg:py-24">
        <RevealItem className="max-w-3xl space-y-4">
          <p className="text-xs uppercase tracking-[0.34em] text-[color:var(--olive)]">What residents say</p>
            ...
            <RevealItem key={testimonial.name}>
              ...
              >
                <div className="space-y-5">
                  <p className="font-display text-[5rem] leading-none text-[color:var(--sand)]/30">“</p>
                  <p className="-mt-8 text-sm leading-7 text-[color:var(--muted)] italic">{testimonial.quote}</p>
                </div>

                <div className="mt-8 flex items-center gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-[color:var(--line-strong)] bg-[color:var(--paper)] font-display text-lg text-[color:var(--sand)]">
